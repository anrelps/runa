  ...
  return (
    ...
    >
      <div className='relative -ml-25 h-112.5 w-87.5 md:-ml-43.75'>
        <Card
          imgUrl={anaImg}
          testimonial='Finalmente consegui organizar minhas finanças de forma simples e eficiente. A melhor decisão que tomei este ano.'
          author='Ana Silva - Empreendedora'
          handleShuffle={handleShuffle}
          position={order[0]}
        />
        <Card
          imgUrl={carlosImg}
          testimonial='Transformou completamente a forma como gerencio meus gastos. Simples, intuitivo e muito eficaz.'
          author='Carlos Santos - Designer'
          handleShuffle={handleShuffle}
          position={order[1]}
        />
        <Card
          imgUrl={mariaImg}
          testimonial='Interface intuitiva e recursos poderosos. Agora consigo planejar meu futuro financeiro com confiança.'
          author='Maria Costa - Desenvolvedora'
          handleShuffle={handleShuffle}
          position={order[2]}
        />
      </div>
